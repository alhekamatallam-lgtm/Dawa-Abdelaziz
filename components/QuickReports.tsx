...
const QuickReports: React.FC<QuickReportsProps> = ({ sessions, onNavigate }) => {
    ...
    const { correctlyLinkedCount, unlinkedCount, duplicateCount } = useMemo(() => {
        ...
        sessions.forEach(s => {
            ...
            // الجلسة تعتبر مكررة إذا تطابق رقم الجلسة (الدعوى) ورقم المخالفة والتاريخ
    ...
    const reports = [
        ...
        },
        {
            ...
            description: "جلسات يتكرر فيها رقم الجلسة مع رقم المخالفة في نفس التاريخ، مما قد يسبب أخطاء.",
